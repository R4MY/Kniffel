...
public class ThreeOfAKind extends CategoryBox
{
    ...
    public ThreeOfAKind(String category, String description, String scoreComposition, List<SectionEnum> sectionsToAddTo)
    {
    ...
    public boolean check(Object currentThrow)
    {
        return DiceRoller.d6.stream()
                .anyMatch(n -> IntegerListHandler.checkHasNumberMinimumTheAmountOfTimes((List<Integer>) currentThrow, n, 3));
    }
